...
import {TableColumn} from "../user-table/user-table.component";
...
@Component({
  selector: 'app-people-organisations',
  templateUrl: './people-organizations.component.html',
  styleUrls: ['./people-organizations.component.scss']
})
export class PeopleOrganizationsComponent {
  page: number = 1;
  pageSize: number = 5;
  pageCount: number = 1;
  ...
  getPageOfPeopleOrganizations(): IPeopleOrganizationUnit[] {
    ...
    const res: IPeopleOrganizationUnit[] = this.filteredPeopleOrganizations.slice(((this.page - 1) * this.pageSize), (this.page * this.pageSize));
